...
For the percentage of schools with specific letter grade accountability ratings, each individual school (Academy, College Prep) has its own rating. The metrics are calculated at the entity and region level as follows: $${\text{Percent of Schools Rated A or B}} = \frac{(\text{Number of Schools Rated A}) + (\text{Number of Schools Rated B})}{\text{Total Number of Schools with Rating in Region}}$$ $${\text{Percent of Schools Rated D or F}} = \frac{(\text{Number of Schools Rated D}) + (\text{Number of Schools Rated F})}{\text{Total Number of Schools with Rating in Region}}$$
...
$${\text{Percent of Schools with Multi-Year Failure}} = \frac{\text{Number of Schools with Multi-Year Failure}}{\text{Total Number of Schools with Rating in Region}}$$
