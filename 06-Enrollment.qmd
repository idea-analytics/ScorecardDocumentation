...
For this metric, a unit (grade level, school, campus, or region) is considered to have met their enrollment goal if the total number of students enrolled on the First Day Of Persistence (FDOP) is at or above the total enrollment goal for that unit.

$${\text{Percentage Meeting Enrollment Goal}} = \frac{\text{Number of Students Enrolled at Unit at FDOP}}{\text{Total Enrollment Goal for Unit}}$$
...
| Unit | School Enrollment at FDOP | School- Target Enrollment | Meets Goal? |
|:--:|:--:|:--:|:--:|
